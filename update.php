<?php
	...
	$minor_id_no_en = $id_details['minor_id_no_en'];
	$minor_id_no_ne = $id_details['minor_id_no_ne'];
	$name_surname_en = $id_details['name_surname_en'];
	$name_surname_ne = $id_details['name_surname_ne'];
	$name_surname_father_en = $id_details['name_surname_father_en'];
	$name_surname_father_ne = $id_details['name_surname_father_ne'];
	$address_father_en = $id_details['address_father_en'];
	$address_father_ne = $id_details['address_father_ne'];
	$name_surname_mother_en = $id_details['name_surname_mother_en'];
	$name_surname_mother_ne = $id_details['name_surname_mother_ne'];
	$address_mother_en = $id_details['address_mother_en'];
	$address_mother_ne = $id_details['address_mother_ne'];
	$ctzn_en = $id_details['ctzn_en'];
	$ctzn_ne = $id_details['ctzn_ne'];
	$name_add_guardian_en = $id_details['name_add_guardian_en'];
	$name_add_guardian_ne = $id_details['name_add_guardian_ne'];
	$birth_date_en = $id_details['birth_date_en'];
	$birth_date_ne = $id_details['birth_date_ne'];
	$birth_place_en = $id_details['birth_place_en'];
	$birth_place_ne = $id_details['birth_place_ne'];
	$birth_ward = $id_details['birth_ward'];
	$place_en = $id_details['place_en'];
	$place_ne = $id_details['place_ne'];
	$ward = $id_details['ward'];
	$officer_name_en = $id_details['officer_name_en'];
	$officer_pos_en = $id_details['officer_pos_en'];
	$officer_name_ne = $id_details['officer_name_ne'];
	$officer_pos_ne = $id_details['officer_pos_ne'];
	$gender = $id_details['gender'];
	$birth_district = $id_details['birth_muni_did'];
	$district = $id_details['muni_did'];
	$cancel = TRUE;

	require_once $_SERVER["DOCUMENT_ROOT"].'/models/address.php';
    $districts = get_districts();

	$title = 'Update ID Detail';
